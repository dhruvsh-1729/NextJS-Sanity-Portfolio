...
export default async function Project({ params }: Props) {
  ...
  return <div className="max-w-3wl mx-auto my-auto py-20 px-20">
    ...
    <Image src={project.image} alt={project.name} width={1080} height={720} className="mt-10 border-2 border-gray-700 object-cover rounded-xl" />
  </div>
} 